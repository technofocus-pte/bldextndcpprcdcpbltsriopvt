...
1.  In VS code, create a file named +++**create_search_index.py**+++ in
    your src folder here it is (that is, the same directory where you
    placed your **assets** folder, not inside the **assets** folder).
...
1.  From the Azure portal, select **Subscriptions** and then select
...
5.  Select the **Metrics** under AI quality and Risk and safety metrics.
